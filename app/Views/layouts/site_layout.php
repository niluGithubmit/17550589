...
<body class="bg-light">
    ...
    <!-- navbar -->
    <?= view('App\Views\components\site_nav') ?>
   ...
   <input type="hidden" id="base_url" value="<?= base_url(); ?>" name="">
    ...
    <script type="text/javascript" src="<?= base_url().'/js/customb.js'?>"></script>
    <!--page js-->
    ...
    <script type="text/javascript" src="<?= base_url().'/script/service_station.js'?>"></script>
     <script type="text/javascript" src="<?= base_url().'/js/modal.js'?>"></script>
    <?php if(isset($page_name) && $page_name=='services'){ ?>
        <script type="text/javascript" src="<?= base_url().'/script/datatables.js'?>"></script>
    <?php } ?>

    
  <script type='text/javascript' src='https://www.bing.com/api/maps/mapcontrol?callback=init&key=AiYAFxZURO_Oxnz26aXJGjjH07946POZezF0rkNzz1gQHiA7pUahgoAdfpyyrkBO' async defer></script>
