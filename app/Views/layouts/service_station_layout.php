...
<body class="bg-light">
    ...
    <!-- navbar -->
    <?= view('App\Views\components\service_station_nav') ?>
   ...
   <input type="hidden" id="base_url" value="<?= base_url(); ?>" name="">
    ...
    <script type="text/javascript" src="<?= base_url().'/script/report.js'?>"></script>
 ...
 <script
  ...
  <script type="text/javascript" src="<?= base_url().'/script/image-cropper.js'?>"></script>
