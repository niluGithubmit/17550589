                                    	...
                                    	<div class="card-body">
                                    		...
                                    		<div class="row">
                                                ...
                                                <div class="col-md-2 text-left">
                                                    ...
                                                    <?php } ?>
                                                    <?php if($item['rate']==2){ ?>
                                                        <h4 class="badge btn-warning">NORMAL</h4>
                                                    <?php } ?>
                                                    <?php if($item['rate']==3){ ?>
                                                        <h4 class="badge btn-info">GOOD</h4>
                                                    <?php } ?>
                                                    <?php if($item['rate']==4){ ?>
                                                        <h4 class="badge btn-success">EXCELLENT</h4>
                                                    <?php } ?>
                                                ...
                                                <?php }else if ($item['status']==1){ ?>
                                                 ...
                                                 <?php }else if ($item['status']==2){ ?>
                                                    ...
                                                    <a href="<?= base_url()."/ap_susp/".$item['id']?>" class="btn btn-warning">Suspended</a>

                                                <?php }else if($item['status']==3){ ?>
                                                    <button disabled class="btn btn-info">Job completed</button>
                                                    <a class="btn btn-success" href="<?=base_url()."/print_invoice/".$item['id']?>">Invoice</a>
                                                <?php } else { ?>
                                                    <button disabled class="btn btn-warning">Suspended</button>
