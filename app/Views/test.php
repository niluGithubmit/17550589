...
<!-- Mirrored from demo.lorvent.com/globals/directory/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Jul 2022 04:44:38 GMT -->
            ...
            <ul class="nav sidebar-nav">
                <li class="profile-box">
                    <div class="sidebar-brand">
                        <img src="images/userprofile.png" class="img-responsive profile" alt="userprofile">
        ...
        <div class="container">
            <nav class="navbar navbar-default">
                ...
                <div class="navbar-header">
                    ...
                    <a href='"index-2.html"'>
                        <img src="images/logo.png" alt="logo" class="global-logo ">
                    </a>
                </div>
            ...
            <ul>
                ...
                <li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on">
                    ...
                    <div class="tp-caption lft customout rs-parallaxlevel-0" data-x="700" data-y="150" data-customout="x:0;y:0;z:0;rotationX:0;rotationY:0;rotationZ:0;scaleX:0.75;scaleY:0.75;skewX:0;skewY:0;opacity:0;transformPerspective:600;transformOrigin:50% 50%;" data-speed="700" data-start="1400" data-easing="Power3.easeInOut" data-elementdelay="0.1" data-endelementdelay="0.1" style="z-index: 3;">
                        <img alt="dummy" src="images/dummy.png" data-lazyload="images/mainimages/img-05.png" style="width:600px;height:500px;">
                    </div>
                    <!-- LAYER NR. 4 -->
            ...
            <div class="row">
                ...
                <div class="col-md-5 col-md-offset-1">
                    <ul class="follow-icons">
                        ...
                        <li>
                            <a href="#">
                                <img class="img-responsive" alt="facebook-icon" src="images/icons/facebook-icon.png">
                            </a>
                        </li>
                        <!-- ./Follow item -->
                        <!-- Follow item -->
                        <li>
                            <a href="#">
                                <img class="img-responsive" alt="twitter-icon" src="images/icons/twitter-icon.png">
                            </a>
                        </li>
                        <!-- ./Follow item -->
                        <!-- Follow item -->
                        <li>
                            <a href="#">
                                <img class="img-responsive" alt="google-icon" src="images/icons/google-icon.png">
                            </a>
                        </li>
                        <!-- ./Follow item -->
                        <!-- Follow item -->
                        <li>
                            <a href="#">
                                <img class="img-responsive" alt="pinterest-icon" src="images/icons/pinterest-icon.png">
                            </a>
                        </li>
                        <!-- ./Follow item -->
                        <!-- Follow item -->
                        <li>
                            <a href="#">
                                <img class="img-responsive" alt="instagram-icon" src="images/icons/instagram-icon.png">
                            </a>
                        </li>
                        <!-- ./Follow item -->
                        <!-- Follow item -->
                        <li>
                            <a href="#">
                                <img class="img-responsive" alt="envato-icon" src="images/icons/envato-icon.png">
                            </a>
                        </li>
                        <!-- ./Follow item -->
                        <!-- Follow item -->
                        <li>
                            <a href="#">
                                <img class="img-responsive" alt="flicker-icon" src="images/icons/flicker-icon.png">
                            </a>
                        </li>
                        <!-- ./Follow item -->
                        <!-- Follow item -->
                        <li>
                            <a href="#">
                                <img class="img-responsive" alt="dribbble-icon" src="images/icons/dribbble-icon.png">
                            </a>
                        </li>
                        <!-- ./Follow item -->
                    </ul>
        ...
        <div class="container">
            <div class="row">
                <div class="col col-md-4">
                    <img src="images/mainimages/footer-logo.png" alt="footer_logo" class="footer-logo-p">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <ol class="breadcrumb copy-right-box">
                        <li>
                            <img alt="copyright" class="copyright-img" src="images/copyright.png">&nbsp; &nbsp; &copy;
                        </li>
...
<!-- Mirrored from demo.lorvent.com/globals/directory/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Jul 2022 04:45:15 GMT -->
</html>
 --> -->