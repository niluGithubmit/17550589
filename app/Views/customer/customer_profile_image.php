...
background: linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(26,218,45,0.711922268907563) 0%, rgba(0,255,235,1) 100%);
		}
	...
	<body>
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="image_area">
						<form method="post">
							<input type="hidden" id="station_id" value="<?=$data['id'];?>" name="">
							<label for="upload_image">
								<?php if(!empty($data['profile_image'])){ ?>
								<img src="<?= base_url().'/'.$data['profile_image']?>" id="uploaded_image" class="img-responsive" />
							<?php }else{ ?>
		...
		<br>
		<div class="row">
			<a href="<?= base_url()."/station_profile/".$data['id'];?>"> <button class="btn btn-danger">Cancel</button></a>
		</div>
	</body>
</html>
